...
#os.chdir('C:\Users\space\DAG-GNN\src')
#os.mkdir(r"C:\Users\space\DAG-GNN\src\logs\exp2021")
#print(os.getcwd())
#sys.exit()
...
def experiment(args):
    ...
    rel_rec = np.array(encode_onehot(np.where(off_diag)[1]), dtype=np.float64) #PRINT 
...
#===================================
    ...
    #log.flush()
        ...
        # test()
        print("iteration is: {:04d}".format(ite))
